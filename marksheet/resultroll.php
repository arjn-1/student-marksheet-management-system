...
$query = "SELECT * FROM form WHERE rollno=$f";
...
<center>
	<table border=1>
		...
		<td>
			<table width=100%>
				<tr><td><font size='4'><?php echo "Student Name: = $stn"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "$gen";?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo"Father's Name: Mr.$fn";?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo"Mother's Name: Mrs.$mn";?></font></td><td><img src=<?php echo"$image"; ?> width=120 height=120></td></tr>
